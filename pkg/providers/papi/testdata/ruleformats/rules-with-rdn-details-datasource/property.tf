...
resource "akamai_property" "test-edgesuite-net" {
  ...
  rule_format = data.akamai_property_rules_builder.test-edgesuite-net_rule_.rule_format
  rules       = data.akamai_property_rules_builder.test-edgesuite-net_rule_.json
}
